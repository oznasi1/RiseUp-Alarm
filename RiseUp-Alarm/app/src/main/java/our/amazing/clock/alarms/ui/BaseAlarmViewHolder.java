...
import our.amazing.clock.dialogs.AddLabelDialog;
import our.amazing.clock.dialogs.AddLabelDialogController;
import our.amazing.clock.dialogs.TimePickerDialogController;
import our.amazing.clock.list.BaseViewHolder;
import our.amazing.clock.list.OnListItemInteractionListener;
...
//        int disabled = ContextCompat.getColor(getContext(), R.color.text_color_disabled_light);
    ...
    private void bindDismissButton(Alarm alarm) {
        ...
        String buttonText = snoozed
                ? getContext().getString(R.string.title_snoozing_until, TimeFormatUtils.formatTime(getContext(), alarm.snoozingUntil()))
