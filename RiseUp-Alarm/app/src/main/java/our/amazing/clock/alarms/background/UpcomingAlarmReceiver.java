...
public class UpcomingAlarmReceiver extends BroadcastReceiver {
    ...
    private static final String ACTION_DISMISS_NOW = "our.amazing.clock.action.DISMISS_NOW";

    public static final String ACTION_CANCEL_NOTIFICATION = "our.amazing.clock.action.CANCEL_NOTIFICATION";
    public static final String ACTION_SHOW_SNOOZING = "our.amazing.clock.action.SHOW_SNOOZING";
    public static final String EXTRA_ALARM = "our.amazing.clock.extra.ALARM";
