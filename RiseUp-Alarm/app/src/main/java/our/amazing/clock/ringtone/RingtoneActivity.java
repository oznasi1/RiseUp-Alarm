...
public abstract class RingtoneActivity<T extends Parcelable> extends BaseActivity {
    ...
    public static final String ACTION_FINISH = "our.amazing.clock.ringtone.action.FINISH";
    public static final String EXTRA_RINGING_OBJECT = "our.amazing.clock.ringtone.extra.RINGING_OBJECT";
    public static final String ACTION_SHOW_SILENCED = "our.amazing.clock.ringtone.action.SHOW_SILENCED";
